...
//import eu.chainfire.libsuperuser.eu.chainfire.StreamGobbler.OnLineListener;
...
public class Shell {
    ...
    public static class SU {
         ...
         *
         * @param shell eu.chainfire.Shell command to run
         * @return eu.chainfire.Shell command appears to be su
         */
         ...
         * @return eu.chainfire.Shell command
         */
    ...
    public static class Builder {
         ...
         *
         * @param shell eu.chainfire.Shell to use
         * @return This Builder object for method chaining
         */
    ...
    public static class Interactive {
        ...
        /**
         * The only way to create an instance: eu.chainfire.Shell.Builder::open()
         *
         ...
         *
         * @return eu.chainfire.Shell running ?
         */
         ...
         *
         * @return eu.chainfire.Shell idle ?
         */
